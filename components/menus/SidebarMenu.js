    ...
    <div class={`${styles.container} transition-all duration-500 ${open ? 'left-0' : 'left-[-400px]'}`}>
        ...
        <div class='pt-10 pl-2 font-light flex flex-col'>
            ...
            <div class='mt-3'>
              {user ? (
                <>
                <button onClick={logout} type="button" class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Sign Out</button>
                </>

              ) : (
                <>
                <button onClick={login} type="button" class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Sign In</button>
                </>
              )}
            </div>
